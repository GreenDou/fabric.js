    ...
    fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
        ...
        setFreeDrawingBrush: function(brush, options) {
            ...
            switch (brush) {
              ...
              default:
              case "pencil":
                if (!(this.freeDrawingBrush && this.isBrushType(this.freeDrawingBrush, fabric.PencilBrush))) {
...
(function() {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        drawSelectionBackground: function(ctx) {
            ...
            ctx.save();
            var center = this.getCenterPoint(), wh = this._calculateCurrentDimensions(), vpt = this.canvas.viewportTransform, iVpt = fabric.util.invertTransform(vpt);
            ctx.translate(center.x, center.y);
